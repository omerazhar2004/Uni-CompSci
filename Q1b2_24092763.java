...
// public class Q1b2_24092763 {
//     private int n;
//     private int[][] square; // Main private variable to store the 2D array and to allow it to be updated when it gets shuffled or when user input impacts the position of elements inside it.
//     public int[][] tempSquare; // Only stores the version of the 2D array that was generated before it gets shuffled later on, this is so the game can compare the final version of the square field with this field in order to decide whether the victory condition was met.
...
// class inputHandling extends Q1b2_24092763 {
...
//     public int validateInput() { // for checking if user input is an integer value
//         Scanner correctInput = new Scanner(System.in);
//         System.out.print("Enter an odd Integer value: ");
...
//         int n = getN(); // retrieving private field from getter methods in superclass
//         int square[][] = getSquare();
//         Random rand = new Random();
//         int shuffleCount = 0; // initialized this value before the while loop.
...
//             System.out.print("Enter input in the provided format to continue editing your square or ending the game. e.g. 1 2 u\nWarning: Only end the game if you're confident that your square is a magic square as you will not be able to retry again.\n");
//             String userInput = correctInput.nextLine().trim();
//             if (userInput.matches("\\d+ \\d+ [ULDREuldre]")) { // ensures that user enters at least 3 inputs to avoid an error message.
...
//                                 newRow = (rowInput + 1 + n) % n; // rowInput and colInput are both also public fields for this superclass and thus accessible to make necessary calculations for determining the output of each direction if entered.
//                                 validInput = true;
